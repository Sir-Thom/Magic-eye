            ...
            <div className="flex items-center  justify-center min-h-screen pt-4 px-4  text-center">
                ...
                >
                    <div className="inline-block align-bottom     text-left  shadow-xl  transform transition-all">
                        <button
                            type={"button"}
                            className="absolute transition ease-in-out delay-150 hover:scale-110 rounded-full top-0 right-0 p-2 text-text-dark  hover:outline-none hover:text-problem-500"
                            onClick={onClose}
                        >
                            <IconX size={20} />
                        </button>
                        <div className=" bg-window-dark-700   rounded-xl px-4 pt-5 pb-4">
