...
export default function RecordSetting({ settings, onSave, postSetting }) {
  ...
  const handleRecordDeleteAfterChange = (event) => {
    ...
    if (match) {
      ...
      setError("Invalid format. Use '1h,' '1m,' '1s,' or a similar format.");
    }
  ...
  return (
    ...
    >
      {settings && (
        <div className=" my-4">
          <h2 className="text-center font-bold text-3xl">Record Setting</h2>
          <div className="grid grid-cols-2  mt-6 content-between place-content-start gap-4">
            <div className="col-span-1">
              <div className="flex flex-col text-right items-end">
                ...
                <label className="my-4">Record Segment Duration:</label>
                <label className="my-3">Record Delete After:</label>
              </div>
            </div>
            <div className="col-span-1">
